              ...
              <table className="min-w-full text-center">
                ...
                {getProductos &&
                  getProductos?.map((p, i) => {
                    if(p.email_U !== usuarioLocal.email_U ){
                    return (
                      <tbody>
                        <tr className="bg-white border-b">
                          ...
                          <td className="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap">
                            <button
                              onClick={(e) => handleEditUserAdmin(p.cod_User)}
                            >
                              <span class="flex-shrink-0 inline-flex mx-3 item-center justify-center leading-none bg-green-500 dark:bg-green-400 hover:bg-green-600  rounded-full">
                                <svg
                                  ...
                                  class="h-7 w-7 md:h-8 md:w-8 text-white"
                                  viewBox="0 0 20 20"
                                  fill="currentColor"
                                >
                                  <path
                          ...
                          <td className="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap">
                            <button
                              onClick={(e) => handleEditUserNoAdmin(p.cod_User)}
                            >
                              <span class="flex-shrink-0 inline-flex mx-3 item-center justify-center leading-none   rounded-full">
                                <svg
                                  ...
                                  stroke-width="1.5"
                                  stroke="currentColor"
                                  class="w-10 h-10 text-red-500 dark:text-red-400 hover:text-red-600 "
                                >
                                  <path
